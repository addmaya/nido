...
?>
<?php if (!empty($pt_next)){ ?>
	<div class="c-next">
		<div class="u-wrap">
	  		<span class="o-subtitle">Next <?php echo $pt_name; ?></span>
	  		<h2><a href="<?php echo get_permalink( $pt_next->ID ); ?>"><?php echo $pt_next->post_title; ?></a></h2>
	  		<div class="o-pager">
	  			<a href="<?php echo get_permalink( $pt_next->ID ); ?>" class="o-pager--next last">
...
<?php } else { if(!empty($pt_prev)){?>
	<div class="c-next">
		<div class="u-wrap">
	  		<span class="o-subtitle">Previous <?php echo $pt_name; ?></span>
	  		<h2><a href="<?php echo get_permalink( $pt_prev->ID ); ?>"><?php echo $pt_prev->post_title; ?></a></h2>
	  		<div class="o-pager">
	  			<a href="<?php echo get_permalink( $pt_prev->ID ); ?>" class="o-pager--prev">
	  				<span class="o-circle"></span>
	  				<div class="o-arrow">
	  					<span class="o-arrow--stem"></span>
	  					<div class="o-arrow--head"><span></span><span></span></div>
